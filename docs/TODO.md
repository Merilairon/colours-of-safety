...
| [ ] Propose edit to any POI or district                                                                                                                                   | `@/frontend/src/app/map/map.html`, `@/frontend/src/app/map/map.ts`, edit-proposal form, `@/backend/src/pois/`, `@/backend/src/districts/` | 2 days   |
| [ ] Review edit-proposal queue with diff                                                                                                                                  | `@/frontend/src/app/review/`, `@/backend/src/pois/`, `@/backend/src/districts/`, new `edits` module                                       | 2 days   |
| [ ] My edits page                                                                                                                                                         | `@/frontend/src/app/submissions/`, `@/backend/src/pois/`, `@/backend/src/districts/`                                                      | 1 day    |

> Status: edit-proposal features not implemented yet. Backend needs `EditProposal` entity + endpoints; frontend needs popup edit button and review diff UI.
...
- [~] Edit suggestions for approved POIs → promoted to P1; see PRD §2 P1 / §3
